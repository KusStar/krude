...
class SettingsRepository(private val context: Context) {
    ...
    companion object {
        ...
        val EXTENSION_GROUP_LAYOUT = booleanPreferencesKey("extension_group_layout")
    ...
    val settingsFlow: Flow<SettingsState> = context.dataStore.data
        .map { preferences ->
            SettingsState(
                ...
                extensionGroupLayout = preferences[EXTENSION_GROUP_LAYOUT] ?: DEFAULT_SETTINGS_STATE.extensionGroupLayout,
                // dev mode
